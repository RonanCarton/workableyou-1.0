...
Devise.setup do |config|
  ...
  config.mailer_sender = "workable2@gmail.com"
  ...
  # config.pepper = "eaf65a53efb886291cda66acb60e0bac97fbf266809883a9c9d395d15226eb4e9be2084b9b993a092d826d4ac0b0a37b5a0811899d0a2f673e1e116cdc16c199"
 ...
 # ["id", "email-address", "first-name", "last-name", "headline", "industry", "picture-url", "public-profile-url", "location"]
  ...
  #config.omniauth :linked_in, ENV['vg8cg31rdett'], ENV['M8EETJdH6YedrTyd']
